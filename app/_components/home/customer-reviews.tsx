    ...
    <section className="bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 py-16 sm:py-24">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 text-center">
          ...
          <a
            href="/contact"
            className="inline-block rounded-md bg-lime-700 dark:bg-lime-500 px-8 py-3 text-base font-semibold text-white shadow-sm hover:bg-lime-800 dark:hover:bg-lime-600 transition-colors"
          >
            상담 신청하기
          </a>
        </div>
